            ...
            v.productOption.map((v2) => {
              return {
                ...
                opt3: truncateOptionName(
                  siteCode[0],
                  v2.productOption3?.name ? ("00" + v2.productOption3.number).slice(-2) + " " + v2.productOption3.name : ""
                ), //옵션타입3의 옵션명
                opt4: truncateOptionName(
                  siteCode[0],
                  v2.productOption4?.name ? ("00" + v2.productOption4.number).slice(-2) + " " + v2.productOption4.name : ""
                ), //옵션타입4의 옵션명
                opt5: truncateOptionName(
                  siteCode[0],
                  v2.productOption5?.name ? ("00" + v2.productOption5.number).slice(-2) + " " + v2.productOption5.name : ""
                ), //옵션타입5의 옵션명
                    ...
                    .map((v: any, i: number) => {
                      ...
                      const a = v.product.productOption.map((v2: any, index2: number) => {
                        ...
                        if (vSiteCode === "A077") {
                          ...
                          opt_price =
                            Math.floor(
                              (opt_price / (100 - (v.product.interparkFee !== null ? v.product.interparkFee : userInfo?.interparkFee))) *
                  ...
                  data: await Promise.all(
                    productStore.map(async (v) => {
                      ...
                      if (vSiteCode === "A077") {
                        ...
                        price =
                          Math.ceil(
                            (price / (100 - (v.product.streetNormalFee !== null ? v.product.streetNormalFee : userInfo?.streetNormalFee))) *
                              (100 / calculateWonType)
                          ) * calculateWonType;
                        discount =
                          Math.ceil(
                        ...
                        price =
                          Math.ceil(
                            (price / (100 - (v.product.wemakepriceFee !== null ? v.product.wemakepriceFee : userInfo?.wemakepriceFee))) *
                              (100 / calculateWonType)
                          ) * calculateWonType;
                        discount =
                          Math.ceil(
                            (discount / (100 - (v.product.wemakepriceFee !== null ? v.product.wemakepriceFee : userInfo?.wemakepriceFee))) *
                              (100 / calculateWonType)
                          ) * calculateWonType;
                      } else if (vSiteCode === "A524") {
                        price =
                      ...
                      return {
                        ...
                        name2:
                          vSiteCode === "B378"
                            ? v.product.productStore.find((v2) => v2.siteCode === vSiteCode && v2.state === 2)?.etcVendorItemId ?? null
