                            ...
                            data: await Promise.all(productStore.map(async v => {
                                ...
                                return {
                                    ...
                                    content: userInfo.optionAlignTop === "N" ? 
                                        `<div style="text-align: center;">${userInfo.fixImageTop ? "<img src=\"" + getValidUploadImageUrl(userInfo.fixImageTop,v.product.taobaoProduct.shopName) + "?" + Date.now() + "\" alt=\"\" />" : ""}${userInfo.fixImageSubTop ? "<img src=\"" + getValidUploadImageUrl(userInfo.fixImageSubTop,v.product.taobaoProduct.shopName) + "?" + Date.now() + "\" alt=\"\" />" : ""}<p>&nbsp;</p><p>&nbsp;</p>${/^product\/\d+\/description.html$/.test(v.product.description) ? (await getFromS3(v.product.description)).Body!.toString("utf8") : v.product.description}${await getOptionHeaderHtmlByProductId(ctx.prisma, v.product.id, userInfo?.optionTwoWays, userInfo?.optionIndexType,v.product.taobaoProduct.shopName)}${userInfo.fixImageBottom ? "<img src=\"" + getValidUploadImageUrl(userInfo.fixImageBottom,v.product.taobaoProduct.shopName)  + "?" + Date.now() +  "\" alt=\"\" />" : ""}${userInfo.fixImageSubBottom ? "<img src=\"" + getValidUploadImageUrl(userInfo.fixImageSubBottom,v.product.taobaoProduct.shopName) + "?" + Date.now() + "\" alt=\"\" />" : ""}</div>`
                                            : 
                                        `<div style="text-align: center;">${userInfo.fixImageTop ? "<img src=\"" + getValidUploadImageUrl(userInfo.fixImageTop,v.product.taobaoProduct.shopName) + "?" + Date.now() + "\" alt=\"\" />" : ""}${userInfo.fixImageSubTop ? "<img src=\"" + getValidUploadImageUrl(userInfo.fixImageSubTop,v.product.taobaoProduct.shopName) + "?" + Date.now() + "\" alt=\"\" />" : ""}${await getOptionHeaderHtmlByProductId(ctx.prisma, v.product.id, userInfo?.optionTwoWays, userInfo?.optionIndexType,v.product.taobaoProduct.shopName)}<p>&nbsp;</p><p>&nbsp;</p>${/^product\/\d+\/description.html$/.test(v.product.description) ? (await getFromS3(v.product.description)).Body!.toString("utf8") : v.product.description}${userInfo.fixImageBottom ? "<img src=\"" + getValidUploadImageUrl(userInfo.fixImageBottom,v.product.taobaoProduct.shopName)  + "?" + Date.now() +  "\" alt=\"\" />" : ""}${userInfo.fixImageSubBottom ? "<img src=\"" + getValidUploadImageUrl(userInfo.fixImageSubBottom,v.product.taobaoProduct.shopName) + "?" + Date.now() + "\" alt=\"\" />" : ""}</div>`,
                                    content1 : userInfo.optionAlignTop === "N" ? 
                                    `<div style="text-align: center;"><p>&nbsp;</p><p>&nbsp;</p>${/^product\/\d+\/description.html$/.test(v.product.description) ? (await getFromS3(v.product.description)).Body!.toString("utf8") : v.product.description}${await getOptionHeaderHtmlByProductId(ctx.prisma, v.product.id, userInfo?.optionTwoWays, userInfo?.optionIndexType,v.product.taobaoProduct.shopName)}</div>`
                                        : 
                                    `<div style="text-align: center;">${await getOptionHeaderHtmlByProductId(ctx.prisma, v.product.id, userInfo?.optionTwoWays, userInfo?.optionIndexType,v.product.taobaoProduct.shopName)}<p>&nbsp;</p><p>&nbsp;</p>${/^product\/\d+\/description.html$/.test(v.product.description) ? (await getFromS3(v.product.description)).Body!.toString("utf8") : v.product.description}</div>`,
