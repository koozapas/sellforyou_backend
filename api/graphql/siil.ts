...
export const getSiilDataForUpload = (siilData: SiilEncodedSavedData | string) => {
	...
	const result: SiilOutputData = {
		...
		infoDetail: data.d.reduce(
			(p, c) => {
				const match = c.c.match(/(\d{2}\d{2})_?(\d?)/);
				if (!match) throw new Error('상품고시정보가 잘못되었습니다.');
				if (match[2] !== '') {
...
export const siilInfo: SiilData[] = [
	{
		...
		data: [
			{
				description:
					'제품 소재 (섬유의 조성 또는 혼용률을 백분율로 표시, 기능성인 경우 성적서 또는 허가서) 예시) 폴리에스터-75%',
				data: [
					{
						name: '제품 소재',
						inputType: 'INPUT',
			...
			{
				description:
					'제조자, 수입품의 경우 수입자를 함께 표기 (병행수입의 경우 병행수입 여부로 대체 가능, 병행수입의 경우“병행수입”입력하면 처리가능)',
				data: [
					{
						name: '제조자',
						inputType: 'INPUT',
	...
	},
	{
		...
		data: [
			...
			{
				description:
					'치수( 발길이: 해외사이즈 표기시 국내사이즈 병행 표기(mm), 굽높이:굽 재료를 사용하는 여성화에 한함(cm) )',
				data: [
					{
						name: '발길이',
						inputType: 'INPUT',
	...
	},
	{
		...
		data: [
			...
			{
				description:
					'KC 인증 필 유무 (전기용품안전관리법 상 안전인증대상전기용품, 안전확인대상전기용품, 공급자적합성확인대상전기용품에 한함)',
				data: [
					{
						name: '인증유형',
						inputType: 'YESNO',
	...
	},
	{
		...
		data: [
			...
			{
				description:
					'소비자의 추가적인 부담사항 (가입비, 유심카드 구입비 등 추가로 부담하여야 할 금액, 부가서비스, 의무사용기간, 위약금 등)',
				data: [
					{
						name: '부담사항',
						inputType: 'INPUT',
	...
	},
	{
		...
		data: [
			...
			{
				description:
					'「수입식품안전관리특별법」에 따른 수입 기구·용기의 경우 “「수입식품안전관리특별법」에 따른 수입신고를 필함”의 문구',
				data: [
					{
						name: '수입품',
						inputType: 'SELECT',
	...
	},
	{
		...
		data: [
			...
			{
				description:
					'영유아식 또는 체중조절식품 등에 해당하는 경우 표시광고 사전심의필여부 [* 전자상거래법 개정으로 인하여 삭제 예정]',
				data: [
					{
						name: '사전심의필여부',
						inputType: 'SELECT',
	...
	},
	{
		...
		data: [
			...
			{
				description:
					'어린이제품 안전 특별법 상 안전인증대상어린이제품, 안전확인대상어린이제품, 공급자적합성확인대상어린이제품에 대한 KC인증 필 유무',
				data: [
					{
						name: '인증유형',
						inputType: 'YESNO',
	...
	},
	{
		...
		data: [
			...
			{
				description:
					'포함 내역 (식사, 인솔자, 공연관람, 관광지 입장료, 유류할증료, 공항이용료, 관련 세금 및 공과금 등)',
				data: [
					{
						name: '포함 내역',
						inputType: 'INPUT',
			...
			{
				description:
					'추가 경비 항목과 금액 (유류할증료가 가격에 포함되지 않은 경우 그 금액과 변동가능성, 선택관광, 안내원 봉사료 등)',
				data: [
					{
						name: '추가 경비',
						inputType: 'INPUT',
	...
	},
	{
		...
		data: [
			...
			{
				description:
					'가격에 포함되지 않은 내역 및 금액 (유류할증료, 공항이용료, 관광지 입장료, 안내원수수료, 식사비용, 선택사항 등)',
				data: [
					{
						name: '추가 경비',
						inputType: 'INPUT',
